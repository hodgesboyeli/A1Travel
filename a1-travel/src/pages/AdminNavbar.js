    ...
    return (
        <nav className="navbar navbar-expand-lg" style={{backgroundColor:"#FFF"}}>
            ...
            <button type="inbox" className="admin-inbox-button btn-md">
                <a className="nav-link" href="http://localhost:3000/admin-inbox"><i className="fas fa-envelope" style={{color: "black"}}></i></a>
            </button>
            <button type="notifications" className="admin-inbox-button btn-md">
                <a className="nav-link" href="http://localhost:3000/admin-notifications"><i className="fas fa-bell" style={{color: "black"}}></i></a>
            </button>
